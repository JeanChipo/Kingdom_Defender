...
Ensemble_fleche =  []
Upgrade_arc = {"cadence" : 0, "dispersion" : [45], "salve" : 1} # Un dictionnaire qui prend en clé le nom de l'amélioration et en objet les valeurs de 0 ou 1 pour dire si l'amélioration est faite où pas (pour les amélioration à plusieurs paliers 1 represente sa création, 2 sa deuxiéme amélioration etc.
upgrade = 1000
wave_number = 1
